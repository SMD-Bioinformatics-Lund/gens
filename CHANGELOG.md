...
### Added
 ...
 - Allow displaying Scout panels as tracks in Gens
...
### Changed
 ...
 - Generalize connection with Scout using an abstract class as interface, opening for interfacing with other alternative variant software
