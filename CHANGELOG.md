...
- Sample caching now considers what case it belongs to. Before if having multiple samples with the same ID from different cases, the caches would not distinguish them. 
