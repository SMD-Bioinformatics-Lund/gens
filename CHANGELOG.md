...
- Allow user to control whether to bgzip+tabix and number threads used in `generate_gens_data.py` [#576](https://github.com/SMD-Bioinformatics-Lund/gens/pull/576).
