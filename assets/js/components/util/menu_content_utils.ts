...
export function getVariantContextMenuContent(id: string, details: ApiVariantDetails, variantUrl: string): HTMLDivElement[] {
...
export function getGenesContextMenuContent(id: string, details: ApiTranscriptDetails): HTMLDivElement[] {
...
export function getAnnotationContextMenuContent(id: string, details: ApiAnnotationDetails): HTMLDivElement[] {
    const info: { key: string; value: string }[] = [
      {
        key: "Range",
