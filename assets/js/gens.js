...
export function initCanvases({ sampleName, caseId, genomeBuild, hgFileDir, uiColors, selectedVariant, annotationFile }) {
  ...
  const ic = new InteractiveCanvas(inputField, lineMargin, near, far, caseId, genomeBuild, hgFileDir)
  ...
  const oc = new OverviewCanvas(ic.x, ic.plotWidth, lineMargin, near, far, caseId, genomeBuild, hgFileDir)
